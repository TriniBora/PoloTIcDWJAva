...
public class MascotaCliente implements Serializable {
    ...
    public MascotaCliente(int num_cliente, String nombre_perro, String raza, String color, String alergico, String atención_especial, String nombre_duenio, String celular_duenio, String observaciones) {
        this.num_cliente = num_cliente;
        this.nombre_perro = nombre_perro;
        this.raza = raza;
        this.color = color;
        this.alergico = alergico;
        this.atencion_especial = atención_especial;
    ...
    public void setAtencion_especial(String atención_especial) {
        this.atencion_especial = atención_especial;
    }
