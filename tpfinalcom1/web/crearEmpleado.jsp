                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtNomEmple">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Apellido</label>
                                                                <input type="text" class="form-control" name="txtApEmple">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtDirEmple">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Teléfono</label>
                                                                <input type="text" class="form-control" name="txtTelEmple">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" name="txtEmailEmple">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Cargo</label>
                                                                <input type="text" class="form-control" name="txtCargoEmple">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">                                                        
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtContrasenia">
                                                            </div>
                                                        </div>
                                                    </div>                                                    
