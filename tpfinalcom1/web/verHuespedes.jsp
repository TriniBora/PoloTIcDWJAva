                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title ">Lista de huéspedes</h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <%
                                                                    long idHuesped = huesped.getId();
                                                                    String nombre = huesped.getNombre();
                                                                    String apellido = huesped.getApellido();
                                                                    String dni = huesped.getDni();
                                                                    String fechaNac = ctrl.fechaDateAString(huesped.getFechaNac());
                                                                    String dir = huesped.getDireccion();
                                                                    String tel = huesped.getTelefono();
                                                                    String email = huesped.getEmail();
                                                                ...
                                                                <td>
                                                                    <form action="SvEliminarHuesped" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idHuesped%>">
