                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-translate">
                            <a class="navbar-brand" href="./habitaciones.jsp">Gestión de habitaciones</a>
                        ...
                        <div class="collapse navbar-collapse">
                            ...
                            <li class="dropdown nav-item">
                                ...
                                <div class="dropdown-menu">
                                        <a href="./crearHabitacion.jsp" class="dropdown-item">
                                            Nueva habitación
                                        </a>
                                        <form action="SvVerHabitaciones" method="GET">
                                        <a href="SvVerHabitaciones" class="dropdown-item SUBMIT">
                            ...
                            <li class="dropdown nav-item">
                                ...
                                <div class="dropdown-menu">
                                        <a href="./crearTipoHabitacion.jsp" class="dropdown-item">
                                            Nuevo tipo habitación
                                        </a>
                                        <form action="SvVerTipoHabitaciones" method="GET">
                                        <a href="SvVerTipoHabitaciones" class="dropdown-item SUBMIT">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title">Editar habitación</h4>
                                                <p class="card-category">Información de la habitación</p>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtNombreHab" value="<%=habitacion.getNombreHab()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Número Piso</label>
                                                                <input type="number" class="form-control" min="1" name="txtNroPiso" value="<%=habitacion.getNroPiso()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Precio por noche</label>
                                                                <input type="text" class="form-control" name="txtPrecio" value="<%=habitacion.getPrecioPorNoche()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form-check-label">Seleccionar el tipo de habitación</label>
                                                                <select class="form-control" name="txtTipoHab">

                                                                    <%
                                                                        List<TipoHabitacion> listaTipoHabitaciones = (List) miSesion.getAttribute("listaTipoHabitaciones");

                                                                        for (TipoHabitacion tipoHab : listaTipoHabitaciones) {

                                                                            String nombreTipo = tipoHab.getNombreTipo();

                                                                    %>

                                                                    <option value="<%=habitacion.getTipoHab().getNombreTipo()%>"><%= nombreTipo%></option>
                                                                <% }%>  
                                                                </select>
                                                            </div>
                                                        </div>
</div>                                               <input type="hidden" name="txtId" value="<%=habitacion.getId_habitacion()%>">
