                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtNomEmple" value="<%=empleado.getNombre()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Apellido</label>
                                                                <input type="text" class="form-control" name="txtApEmple" value="<%=empleado.getApellido()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtDniEmple" value="<%=empleado.getDni()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Fecha Nacimiento</label>
                                                                <input type="date" class="form-control" name="txtFechaNac" value="<%=empleado.getFechaNac()%>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtDirEmple" value="<%=empleado.getDireccion()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Teléfono</label>
                                                                <input type="text" class="form-control" name="txtTelEmple" value="<%=empleado.getTelefono()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" name="txtEmailEmple" value="<%=empleado.getEmail()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Cargo</label>
                                                                <input type="text" class="form-control" name="txtCargoEmple" value="<%=empleado.getCargo()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <h4 class="card-title text-rose">Información del sistema</h4>
                                                    <div class="row">                                                        
                                                        <div class="col-md-6">                                                            
                                                            <div class="form-group">
                                                                <label class="label">Nombre de usuario</label>
                                                                <input type="text" class="form-control" name="txtUsername" value="<%=empleado.getUsuario().getUsername()%>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Contraseña</label>
                                                                <input type="text" class="form-control" name="txtContrasenia" value="<%=empleado.getUsuario().getContrasenia()%>">
                                                            </div>
                                                        </div>
                                                    </div>                 
                                                            
                                                    <input type="hidden" name="txtId" value="<%=empleado.getId()%>">
                                                    <button type="submit" class="btn btn-rose pull-right">Guardar</button>
