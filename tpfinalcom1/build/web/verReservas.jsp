                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                List<Reserva> listaReservas = (List) miSesion.getAttribute("listaReservas");
                                                                for (Reserva reserva : listaReservas){                                                           
                                                            %>
                                                            <tr>
                                                                <%
                                                                    long idReserva = reserva.getId_reserva();
                                                                    String fechaEnt = ctrl.fechaDateAString(reserva.getFechaEntrada());
                                                                    String fechaSal = ctrl.fechaDateAString(reserva.getFechaSalida());
                                                                    int cantPer = reserva.getCantPersonas();
                                                                    double monto = reserva.getMontoTotal();
                                                                    String dniHuesped = reserva.getHuesped().getDni();
                                                                    String habitacion = reserva.getHabitacion().getNombreHab();
                                                                    String username = reserva.getUsuario().getUsername();
                                                                %>
                                                                ...
                                                                <td>
                                                                    <form action="SvEliminarReserva" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idReserva%>">
                                                                        <button type="submit" class="btn btn-danger pull-left" >Eliminar</button>
                                                                    </form>
                                                                </td>
                                                                <td>
                                                                    <form action="SvEditarReserva" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idReserva%>">
