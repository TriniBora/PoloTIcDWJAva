                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title">Editar Huésped</h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtNombre" value="<%=huesped.getNombre()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Apellido</label>
                                                                <input type="text" class="form-control" name="txtApellido" value="<%=huesped.getApellido()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtDni" value="<%=huesped.getDni()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Fecha Nacimiento</label>
                                                                <input type="date" class="form-control" name="txtFechaNac" value="<%=huesped.getFechaNac()%>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="txtDireccion" value="<%=huesped.getDireccion()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Teléfono</label>
                                                                <input type="text" class="form-control" name="txtTelefono" value="<%=huesped.getTelefono()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" name="txtEmail" value="<%=huesped.getEmail()%>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="label">Profesión</label>
                                                                <input type="text" class="form-control" name="txtProfesion" value="<%=huesped.getProfesion()%>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                            
                                                    <input type="hidden" name="txtId" value="<%=huesped.getId()%>">
