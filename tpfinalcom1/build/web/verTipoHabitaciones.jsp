                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-translate">
                            <a class="navbar-brand" href="#">Gestión de habitaciones</a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title ">Lista de tipos de habitaciones</h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <%
                                                                    long idTipoHab = tipoHab.getId_tipo();
                                                                    String nombreTipoHab = tipoHab.getNombreTipo();
                                                                    int cantMaxPer = tipoHab.getCantMaxPersonas();
                                                                %>
                                                                ...
                                                                <td>
                                                                    <form action="SvEliminarTipoHabitacion" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idTipoHab%>">
                                                                        <button type="submit" class="btn btn-danger pull-left" >Eliminar</button>
                                                                    </form>
                                                                </td>
                                                                <td>
                                                                    <form action="SvEditartipoHabitacion" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idTipoHab%>">
                                                                        <button type="submit" class="btn btn-default pull-left">Editar</button>
                                                                    </form>
                                                                </td>
                                                            </tr>
