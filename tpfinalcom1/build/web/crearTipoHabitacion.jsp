                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-translate">
                            <a class="navbar-brand" href="./personas.jsp">Gestión de habitaciones</a>
                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-header card-header-rose">
                                                <h4 class="card-title">Crear tipo habitación</h4>
                                            </div>
                                            <div class="card-body">
                                                <form action="SvCrearTipoHabitacion" method="POST">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-check-label">Seleccionar el nombre del tipo de habitación</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-check-label">Seleccionar la cantidad máxima de personas</label>
                                                                <select class="form-control" name="txtCantMaxPer">
