                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-warning">
                                                <h4 class="card-title ">Lista de habitaciones</h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <%
                                                                    long idHab = habitacion.getId_habitacion();
                                                                    String nombreHab = habitacion.getNombreHab();
                                                                    int nroPiso = habitacion.getNroPiso();
                                                                    double precio = habitacion.getPrecioPorNoche();
                                                                    String tipoHab = habitacion.getTipoHab().getNombreTipo();
                                                                ...
                                                                <td>
                                                                    <form action="SvEliminarHabitacion" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idHab%>">
                                                                        <button type="submit" class="btn btn-danger pull-left" >Eliminar</button>
                                                                    </form>
                                                                </td>
                                                                <td>
                                                                    <form action="SvEditarHabitacion" method="POST">
                                                                        <input type="hidden" name="txtId" value="<%=idHab%>">
